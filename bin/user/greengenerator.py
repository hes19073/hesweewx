...
# =============================================================================
#                    Class GreenGenerator
# =============================================================================

class GreenGenerator(weewx.reportengine.ReportGenerator):
    ...
    def genImages(self, gen_ts):
        ...
        for species_name in self.green_dict.sections:
            ...
            species_options = weeutil.config.accumulateLeaves(self.green_dict[species_name])
            ...
            if skipThisPlot(plotgen_ts, ai, img_file):
                ...
                try:
                    ...
                    log.critical("GreenGenerator: Unable to save to file '%s' %s:", img_file, e)
                t2 = time.time()
                if self.log_success:
                    log.info("GreenGenerator: Generated %d images for %s in %.2f seconds",
    ...
    def get_vectors(self, stamps, csv_file_name):
        ...
        try:
            ...
            log.critical("Greengenerator: Unable to read file '%s' %s:", csv_file_name, e)
        return result
...
class GreenReportGenerator(weewx.reportengine.ReportGenerator):
    ...
    def generate(self, green_dict, species_name):
        ...
        report_dict = weeutil.config.accumulateLeaves(green_dict[species_name])
