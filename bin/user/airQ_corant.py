...
class AirqService(StdService):
    ...
    AIRQ_DATA = {
        ...
        'measuretime': ('airqMeasuretime', 'second', 'group_elapsed', lambda x:int(x)),
        'uptime':      ('airqUptime',      'second', 'group_elapsed', lambda x:int(x)),
        ...
        'TypPS':       ('airqTypPS',       'count',   'group_count', lambda x:x),
        'bat':         ('airqBattery',     'count',   'group_count', lambda x:x[0]),
        'door_event':  ('airqDoorEvent',   'count',   'group_count', lambda x:int(x)),
        'dHdt':        ('airqHumAbsDelta', 'count',   'group_count', lambda x: x),
        'dCO2dt':      ('airqCO2delta',    'count',   'group_count', lambda x: x),
        'bat_e':         ('airqBattery_e',   'count',   'group_count',   lambda x:x[1]),
