...
class AqiCarService(weewx.engine.StdService):
    '''
    [AqiCarService]
        [standard]
    ...
    def __init__(self, engine, config_dict):
        super(AqiCarService, self).__init__(engine, config_dict)

        # configure the aqi standard
        standard_config_dict = config_dict['AqiCarService']['standard']
        ...
        sensor_config_dict = config_dict['AqiCarService']['air_sensor']
    ...
    def _join_sensor_results(self,
                             pollutant_observations, pollutant_cols,
