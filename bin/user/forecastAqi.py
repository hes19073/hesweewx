...
class AerisAqiMonitor(StdService):
    ...
    def get_data(self, now_ts, last_ts):
        ...
        try:
            ...
            record['aqitime'] = data['response'][0]['periods'][0]['timestamp']
            record['aqi'] = data['response'][0]['periods'][0]['aqi']
            record['o3'] = data['response'][0]['periods'][0]['pollutants'][0]['valueUGM3']
            record['pm25'] = data['response'][0]['periods'][0]['pollutants'][1]['valueUGM3']
            record['pm10'] = data['response'][0]['periods'][0]['pollutants'][2]['valueUGM3']
            record['co'] = data['response'][0]['periods'][0]['pollutants'][3]['valueUGM3']
            record['no2'] = data['response'][0]['periods'][0]['pollutants'][4]['valueUGM3']
            record['so2'] = data['response'][0]['periods'][0]['pollutants'][5]['valueUGM3']
            # record['aqicategory'] = data['response'][0]['periods'][0]['category']
            # record['aqicolor'] = data['response'][0]['periods'][0]['color']
            # record['aqimethod'] = data['response'][0]['periods'][0]['method']
