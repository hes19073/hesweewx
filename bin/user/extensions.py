...
obs_group_dict['aqitime'] = 'group_time'
obs_group_dict['green_day'] = 'group_time'
obs_group_dict['green_sum'] = 'group_anzahl2'
obs_group_dict['coolT_sum'] = 'group_anzahl2'
obs_group_dict['warmT_sum'] = 'group_anzahl2'
obs_group_dict['next_date'] = 'group_time'
obs_group_dict['up_date'] = 'group_time'
obs_group_dict['earthquake_dist'] = 'group_distance'
obs_group_dict['earthquake_time'] = 'group_time'
obs_group_dict['earthquake_magnitude'] = 'group_anzahl1'
...
obs_group_dict['extraTempO0'] = 'group_temperature'
obs_group_dict['extraTempO1'] = 'group_temperature'
obs_group_dict['extraTempO2'] = 'group_temperature'
obs_group_dict['extraTempO3'] = 'group_temperature'
obs_group_dict['extraTempO4'] = 'group_temperature'
obs_group_dict['extraTempO5'] = 'group_temperature'
obs_group_dict['extraTempO6'] = 'group_temperature'
obs_group_dict['extraTempO7'] = 'group_temperature'
obs_group_dict['cpu_temp'] = 'group_temperature'
obs_group_dict['cpu_temp1'] = 'group_temperature'
obs_group_dict['cpu_temp2'] = 'group_temperature'
obs_group_dict['cpu_temp3'] = 'group_temperature'
...
obs_group_dict['cnt0_3'] = 'group_anzahl2'
obs_group_dict['cnt0_5'] = 'group_anzahl2'
obs_group_dict['cnt1_0'] = 'group_anzahl2'
obs_group_dict['cnt2_5'] = 'group_anzahl2'
obs_group_dict['cnt5_0'] = 'group_anzahl2'
obs_group_dict['cnt10_0'] = 'group_anzahl2'
...
obs_group_dict['eleCTotal'] = 'group_count'
obs_group_dict['elePVTotal'] = 'group_count'
obs_group_dict['gasTotal'] = 'group_count'
obs_group_dict['wasTotal'] = 'group_count'
obs_group_dict['wasATotal'] = 'group_count'
obs_group_dict['eleZahl'] = 'group_anzahl2'
obs_group_dict['eleAZahl'] = 'group_anzahl2'
obs_group_dict['eleCZahl'] = 'group_anzahl2'
obs_group_dict['elePVZahl'] = 'group_anzahl2'
obs_group_dict['gasZahl'] = 'group_anzahl3'
obs_group_dict['wasZahl'] = 'group_anzahl4'
obs_group_dict['wasAZahl'] = 'group_anzahl4'
obs_group_dict['wasADelta'] = 'group_anzahl'
obs_group_dict['eleADelta'] = 'group_anzahl'
obs_group_dict['eleCDelta'] = 'group_anzahl'
obs_group_dict['elePVDelta'] = 'group_anzahl'
obs_group_dict['wasDelta'] = 'group_anzahl'
obs_group_dict['eleDelta'] = 'group_anzahl'
obs_group_dict['gasDelta'] = 'group_anzahl'
obs_group_dict['wasAZ_preis'] = 'group_preis'
obs_group_dict['eleAZ_preis'] = 'group_preis'
obs_group_dict['eleCZ_preis'] = 'group_preis'
obs_group_dict['wasZ_preis'] = 'group_preis'
obs_group_dict['eleA_preis'] = 'group_preis'
obs_group_dict['eleC_preis'] = 'group_preis'
obs_group_dict['eleZ_preis'] = 'group_preis'
obs_group_dict['gasZ_preis'] = 'group_preis'
obs_group_dict['ele_kWh'] = 'group_strom'      # energy'
obs_group_dict['eleA_kWh'] = 'group_strom'     # energy'
obs_group_dict['gas_kWh'] = 'group_strom'
obs_group_dict['gasZ_kWh'] = 'group_strom'
obs_group_dict['eleC_kWh'] = 'group_strom'
